...
public class Mouvement : MonoSingleton<Mouvement>
{
    ...
    public void Highlight(int tileId, int Range, int lasttileId)
    {
        ...
        if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Route, tileId) && Range == 0 && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant && !RaycastManager.Instance.ActualTileSelected.GetComponent<UnitScript>().RestreintAuxRails)
        {
            foreach (int ID in PlayerStatic.GetNeighbourDiag(tileId, TilesManager.Instance.TileList[tileId].GetComponent<TileScript>().Line, false))
            {
                ...
                foreach (MYthsAndSteel_Enum.TerrainType Type in TileSc.TerrainEffectList)
                {
                    ...
                    else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Est, tileId) && PlayerStatic.CheckDirection(tileId, ID) == MYthsAndSteel_Enum.Direction.Est && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Est, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain)
                    {
                        i = true;
                    }
                    else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Nord, tileId) && PlayerStatic.CheckDirection(tileId, ID) == MYthsAndSteel_Enum.Direction.Nord && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Nord, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain)
                    {
                        i = true;
                    }
                    else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Sud, tileId) && PlayerStatic.CheckDirection(tileId, ID) == MYthsAndSteel_Enum.Direction.Sud && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Sud, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain)
                    {
                        i = true;
                    }
                    else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Ouest, tileId) && PlayerStatic.CheckDirection(tileId, ID) == MYthsAndSteel_Enum.Direction.Ouest && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Ouest, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain)
                    {
                        i = true;
                    }
                    else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Haute_colline, ID) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain)
                    {
                        i = true;
                    }
                    else if ((PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Mont, ID) || PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Forêt, ID)) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain)
                    {
                        i = true;
                    }
                }
        ...
        else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Route, tileId) && Range == 1 && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant && !RaycastManager.Instance.ActualTileSelected.GetComponent<UnitScript>().RestreintAuxRails)
        {
            foreach (int ID in PlayerStatic.GetNeighbourDiag(tileId, TilesManager.Instance.TileList[tileId].GetComponent<TileScript>().Line, false))
            {
                TileScript TileSc = TilesManager.Instance.TileList[ID].GetComponent<TileScript>();
        ...
        else if (Range > 0)
        {
            foreach (int ID in PlayerStatic.GetNeighbourDiag(tileId, TilesManager.Instance.TileList[tileId].GetComponent<TileScript>().Line, false))
            {
                ...
                if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Ravin, ID) || PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Eau, ID) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                {
                    i = true;
                }
                else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Haute_colline, ID) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                {
                ...
                else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Haute_colline, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                {
                ...
                else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Est, tileId) && PlayerStatic.CheckDirection(tileId, ID) == MYthsAndSteel_Enum.Direction.Est && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Est, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                {
                    i = true;
                }
                else if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Nord, tileId) && PlayerStatic.CheckDirection(tileId, ID) == MYthsAndSteel_Enum.Direction.Nord && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Nord, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                ...
                else if ((PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Mont, ID) || PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Forêt, ID)) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                {
                    if (Range >= 2)
                    {
                        TilesManager.Instance.TileList[ID].GetComponent<TileScript>().ActiveChildObj(MYthsAndSteel_Enum.ChildTileType.MoveSelect, _selectedSprite);
            ...
            if (newNeighbourId.Contains(tileId)) // Si cette case est dans la range de l'unité.
            {
                if (_selectedTileId.Contains(tileId))// Si cette case est déjà selectionnée.
                {
                    ...
                    for (int i = _selectedTileId.IndexOf(tileId); i < _selectedTileId.Count; i++)
                    {
                        ...
                        if ((PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Forêt, _selectedTileId[i]) || PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Mont, _selectedTileId[i])) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                        {
                ...
                else if (PlayerStatic.IsNeighbour(tileId, _selectedTileId[_selectedTileId.Count - 1], TilesManager.Instance.TileList[tileId].GetComponent<TileScript>().Line, false))
                {
                    ...
                    if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Est, tileId) && PlayerStatic.CheckDirection(tileId, _selectedTileId[_selectedTileId.Count - 1]) == MYthsAndSteel_Enum.Direction.Est && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Est, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
                        check = true;
                    }
                    if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Nord, tileId) && PlayerStatic.CheckDirection(tileId, _selectedTileId[_selectedTileId.Count - 1]) == MYthsAndSteel_Enum.Direction.Nord && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Nord, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
                        check = true;
                    }
                    if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Sud, tileId) && PlayerStatic.CheckDirection(tileId, _selectedTileId[_selectedTileId.Count - 1]) == MYthsAndSteel_Enum.Direction.Sud && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Sud, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
                        check = true;
                    }
                    if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Rivière_Ouest, tileId) && PlayerStatic.CheckDirection(tileId, _selectedTileId[_selectedTileId.Count - 1]) == MYthsAndSteel_Enum.Direction.Ouest && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Pont_Ouest, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
                        check = true;
                    }
                    if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Haute_colline, tileId) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
                    ...
                    if (PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Haute_colline, _selectedTileId[_selectedTileId.Count - 1]) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
                        if (!PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Colline, tileId) && !PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Haute_colline, tileId))
                        {
                            check = true;
                    ...
                    if ((PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Forêt, tileId) || PlayerStatic.CheckTiles(MYthsAndSteel_Enum.TerrainType.Mont, tileId)) && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().ToutTerrain && !RaycastManager.Instance.ActualUnitSelected.GetComponent<UnitScript>().Volant)
                    {
