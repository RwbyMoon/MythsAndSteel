...
public class MonteeDAdrenaline : Capacity
{
    public override void StartCpty()
    {
        ...
        if (ressourcePlayer >= Capacity1Cost && GetComponent<UnitScript>().ActifUsedThisTurn == false)
        {
            ...
            GameManager.Instance.StartEventModeTiles(1, GetComponent<UnitScript>().UnitSO.IsInRedArmy, tile, "Montée d'Adrénaline", "Voulez-vous vraiment utiliser cette capacité?");
        }
        base.StartCpty();
    }
