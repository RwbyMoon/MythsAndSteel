...
public class EfficaciteDeTerrain : MonoBehaviour
{
    ...
    void Start()
    {
        GetComponent<UnitScript>().DoubleRessource = true;
        AddBonus();
    ...
    private void AddBonus()
    {
        ...
        if (ApplyBonus.Count > 0)
        {
            foreach (GameObject id in ApplyBonus)
            {
                ...
                {
                    HasBonus.Add(U);
                    U.GetComponent<UnitScript>().DoubleRessource = true;
                }
            }
        }
        WaitBonusEnd = false;
    ...
    void RemoveBonus()
    {
        ...
        {
            U.GetComponent<UnitScript>().DoubleRessource = false;
        }
